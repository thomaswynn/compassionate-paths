    ...
    head: () => ({
          meta: [
            { title: "Eligibility | The Revive Project, LLC" },
            {
                      name: "description",
                      content:
                                  "Learn who qualifies for compassionate release in California. Elderly adults, serious illness, and examples of cases we help.",
            },
            { property: "og:title", content: "Eligibility | The Revive Project, LLC" },
            {
                      property: "og:description",
                      content:
                                  "Compassionate release eligibility criteria in California for elderly and medically ill incarcerated adults.",
            },
                ...
                <header className="sticky top-0 z-30 border-b border-border/70 bg-background/85 backdrop-blur">
                        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
                                  <Link to="/" className="leading-tight">
                                              <p className="font-display text-lg font-semibold">The Revive Project, LLC</p>p>
                                              <p className="rule-eyebrow">Compassionate Release Consulting</p>p>
                                  </Link>Link>
                ...
                <main>
                        <section className="surface-warm">
                                  <div className="mx-auto max-w-4xl px-5 py-16 md:py-20">
                                              <p className="rule-eyebrow text-ink-foreground/60">Who Qualifies</p>p>
                        ...
                        <section className="mx-auto max-w-6xl px-5 py-16">
                          ...
                          <article key={i} className="rounded-sm border border-border bg-card p-7">
                                          <h2 className="text-2xl font-semibold">{item.title}</h2>h2>
                                          <p className="mt-3 text-base leading-relaxed text-muted-foreground">{item.body}</p>p>
                          </article>article>
                        ))}
                                  </div>div>
                        </section>section>
                        ...
                        <section className="mx-auto max-w-4xl px-5 py-16">
                                  <div className="rounded-sm bg-secondary/40 p-8">
                                              <h2 className="text-3xl md:text-4xl">Not sure if your loved one qualifies?</h2>h2>
                ...
                <footer className="border-t border-border bg-card">
                        <div className="mx-auto max-w-6xl px-5 py-12">
                                  <div className="grid gap-10 md:grid-cols-4">
                                              ...
                                              <div>
                                                            <p className="rule-eyebrow">Contact</p>p>
                                                            <address className="mt-4 space-y-3 text-base not-italic leading-relaxed text-muted-foreground">
                                                                            ...
                                                                            <p>Monday – Friday, 8:00 AM – 5:00 PM PT</p>p>
                                                            </address>address>
                                              </div>div>
                                              <div>
                                                            <p className="rule-eyebrow">Site</p>p>
                                  ...
                                  <div className="mt-10 flex flex-col gap-2 border-t border-border pt-6 text-base text-muted-foreground md:flex-row md:items-center md:justify-between">
                                              <p>© {new Date().getFullYear()} The Revive Project, LLC — California</p>p>
                                              <p>Consulting and case support. Not a law firm; not legal or medical advice.</p>p>
                                  </div>div>
                        </div>div>
                </footer>footer>
          </div>div>
        );
}</div>import { createFileRoute, Link } from "@tanstack/react-router";
import reviveLogo from "@/assets/revive Phoenix.png";
...
const criteria = [
  {
    title: "Age & Long Sentence",
    body: "You are 60+ years old and have already served 30+ years.",
    example: "Walter, 72, served 45 years for a crime committed at 27.",
  },
  {
    title: "Serious Medical Illness",
    body: "You have a terminal illness (prognosis <18 months), advanced dementia, or a chronic condition making incarceration unsafe.",
    example: "Maria, 68, diagnosed with stage 4 cancer and declining rapidly.",
  },
  {
    title: "Significant Rehabilitation",
    body: "You have shown genuine change: education, programming, zero disciplinary infractions, and community plans.",
    example: "James, 65, got his GED, mentored other incarcerated people, and has housing lined up.",
  },
  {
    title: "Low Risk to Public Safety",
    body: "You have no current gang affiliations, no violent history, and strong family or community ties.",
